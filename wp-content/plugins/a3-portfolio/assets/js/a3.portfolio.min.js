...
jQuery(document).ready(function () {
	...
	function a3_portfolio_openDetailView(active_larg_img, portfolio_boxes,thumb) {
        ...
        var keikiNumber = thumb.children('.a3-portfolio-item-expander-content').find('[data-keiki]').data('keiki'),
            keikiIframe = '<iframe style="width:100%; height:700px;" src="//e.issuu.com/embed.html#'+ keikiNumber +'" frameborder="0" allowfullscreen></iframe>';
        
		jQuery('body').append( a3_portfolio_script_params.expander_template ).find('.a3-portfolio-inner-wrap').append( keikiIframe );
...
jQuery(function() {	
	var issueOpen = window.location.hash;
	if ( issueOpen ) {
		var issueNmb = issueOpen.replace('#item-','');
		jQuery('.a3-portfolio-box-content').find('.a3-portfolio-item').eq(issueNmb).find('a').click()
	}
	//jQuery(".a3-portfolio-item-first .a3-portfolio-card-overlay").click();
});
